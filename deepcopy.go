...
// 拷贝指针
func (d *deepCopy) cpyPtr(dst, src reflect.Value, dstBase, srcBase unsafe.Pointer, depth int, of offsetAndFunc, all *allFieldFunc) error {
	...
	return d.deepCopy(dst, src, dstBase, srcBase, depth, of, all)
}
